...
export default {
    ...
    data(){
        ...
        mockNexterData: [0.33, 0.25 ,0.74 ,0.66 ,0.33],
        mockMeanNexterData: [0.35, 0.16, 0.64, 0.45, 0.95],
        mockSCGData: [0.65, 0.35, 0.15, 0.76, 0.98],
        mockMeanSCGData: [0.93, 0.24, 0.85, 0.64, 0.31]
        }
    },
    watch:{
    ...
    methods:{
        ...
        fetchCopo(setMain, setBar, setLine, mockNexterData, mockMeanNexterData, mockSCGData, mockMeanSCGData ){
            ...
            if(this.$store.state.buinessUnit === 'SCG'){
                ...
                const ctx =document.getElementById("selfreport-p");
